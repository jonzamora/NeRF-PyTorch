...
def get_args():
    ...
    parser.add_argument("--device", type=str, default="cuda", help="either 'cuda' or 'cpu' for device")

    # DATASET
    parser.add_argument("--dataset_type", type=str, default='blender', help='options: llff / blender / deepvoxels')
    ...
    # deepvoxels
    parser.add_argument("--shape", type=str, default='greek', help='options : armchair / cube / greek / vase') # deepvoxels
    ...
    parser.add_argument("--n_iters", type=int, default=100_000, help='number of iterations to train NeRF')
    ...
    parser.add_argument("--render_factor", type=int, default=1, help='downsampling factor to speed up rendering, set 4 or 8 for fast preview')    

    # LOGGING & SAVING
    parser.add_argument("--i_print", type=int, default=100, help='frequency of console printout and metric loggin')
    parser.add_argument("--i_img", type=int, default=10000, help='frequency of tensorboard image logging')
    parser.add_argument("--i_weights", type=int, default=10000, help='frequency of weight ckpt saving')
    parser.add_argument("--i_testset", type=int, default=50000, help='frequency of testset saving')
    parser.add_argument("--i_video",   type=int, default=20000, help='frequency of render_poses video saving')
